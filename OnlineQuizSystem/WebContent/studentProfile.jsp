							...
							<form action="" method="">
								...
								<div class="form-group">
									<label>Student Id.:</label> <input type="text" name="sid"
										class="form-control" value="<%=resultSet.getInt("id")%>" readonly>
								</div>
								<div class="form-group">
									<label>Student Name.:</label> <input type="text" name="sname"
										class="form-control" value="<%=resultSet.getString("studentName")%>">
								</div>
								...
								<div class="form-group">
									<label>Mobile No.:</label> <input type="text" name="mobile"
										class="form-control" value="<%=resultSet.getString("mobile")%>">
								</div>
								<div class="form-group">
									<label>Education.:</label> <input type="text" name="education"
										class="form-control" value="<%=resultSet.getString("education")%>">
								</div>
								<div class="form-group">
									<label>User Name.:</label> <input type="text" name="uname"
										class="form-control" value="<%=resultSet.getString("uname")%>"
										readonly>
								</div>
								<div class="form-group">
									<label>Password.:</label> <input type="password" name="upass"
										class="form-control" value="<%=resultSet.getString("upass")%>">
								</div>
							</form>
						</div>
					</div>
