	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Notes Prepration Material</h4>

				</div>
			</div>
			<div class="col-md-12">
				<div class="panel panel-success">
					<div class="panel-heading">Notes Prepration Material</div>
					<div class="panel-body">
						...
						<div class="table-responsive">
							<table class="table">
								...
								<%
									ResultSet rs = DatabaseConnection.getResultFromSqlQuery("select * from tblnotes");
									while (rs.next()) {
								%>
								<tbody>
									<tr>
										<td><%=rs.getInt("notes_id")%></td>
										<td><%=rs.getString("notes_name")%></td>
										<td><a href="NotesDownload?notes_id=<%=rs.getInt("notes_id")%>"
