	...
	<div class="content-wrapper">
		<div class="container">
			<div class="row pad-botm">
				<div class="col-md-12">
					<h4 class="header-line">Students Feedback</h4>
				</div>
			</div>
			<div class="row">
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="form-group">
								<label>Student Name : </label> <font color="orange"><%=resultset.getString("sname")%></font>
							</div>
							<div class="form-group">
								<label>Portal Review : </label> <font color="green"><%=resultset.getString("review")%></font>
							</div>
							<div class="form-group">
