							...
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table">
										...
										<%
											ResultSet studentResultReport = DatabaseConnection.getResultFromSqlQuery("select distinct studentId from tblstudentresult");
											while (studentResultReport.next()) {
											ResultSet studentInfo = DatabaseConnection.getResultFromSqlQuery("select * from student where id='" + studentResultReport.getInt("studentId") + "'");
