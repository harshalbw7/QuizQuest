		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-sm-6 col-xs-12">
					<img src="images/forgot-password.jpg" style="width: 450px; height: 300px;">
				</div>
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="panel panel-info">
						<div class="panel-heading">Forget Password</div>
						<div class="panel-body">
							<form action="student-forgot-password-process.jsp" method="post">
								<div class="form-group">
									<label>Enter Your Registered Email Id Here.:</label> <input type="text" name="email"
